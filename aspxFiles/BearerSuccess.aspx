5<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BearerSuccess.aspx.cs" Inherits="DemoProject.BearerSuccess" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="content">
            <div id="image1">
                <img src="Images/undraw_order_confirmed_aaw7.png" width="700"/>
            </div>
            <div id="info">
                <center><h2 style="color:#327ABD;">Transaction Successfull !!</h2></center><br />
                <table class="table">
                    ...
                    <tr>                        
                        ...
                        <td><asp:Label ID="lbltype" runat="server" Text="Bearer"></asp:Label></td>
        ...
        <ul>
            <li>The bearer type cheque can be used by any person to withraw cash from bank</li>
            <li>In our system,the bank will provide payee with a unique transaction ID<br /></li>
