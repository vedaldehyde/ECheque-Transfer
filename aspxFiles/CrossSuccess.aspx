<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrossSuccess.aspx.cs" Inherits="DemoProject.CrossSuccess" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="content">
            <div id="image1">
                <img src="Images/undraw_confirmation_2uy0.png" width="700"/>
            </div>
            <div id="info">
                <center><h2 style="color:#00BFA6;">Transaction Successfull !!</h2></center><br />
                <table class="table">
                    ...
                    <tr>                        
                        ...
                        <td><asp:Label ID="lbltype" runat="server" Text="Cross"></asp:Label></td>
        ...
        <ul>
            <li>The cross type cheque directly transfers the amount to the drawer's account</li>
            <li> In this case you cannot withraw cash<br /></li>
        </ul>
    </form>
</body>
</html>
