...
{
    public partial class Bearer : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string q = "insert into UserStatus(CType,accno,TransID,pass,Vdate,Vmonth,Vyear,status)values('" + "Bearer" + "','" + Txtaccno.Text + "','" + uid + "','" + "NIL" + "','"+""+"','"+""+"','"+""+"','"+"Not Verified"+"')";
