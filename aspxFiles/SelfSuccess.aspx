<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelfSuccess.aspx.cs" Inherits="DemoProject.SelfSuccess" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="content">
            <div id="image1">
                <img src="Images/undraw_verified_tw20.png" width="700" />
            </div>
            <div id="info">
                <center><h2 style="color:#6C63FF;">Transaction Successfull !!</h2></center>
                <br />
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <asp:Label ID="lblacc" runat="server" Text=""></asp:Label></td>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="lbltype" runat="server" Text="Self"></asp:Label></td>
                            <td>
        ...
        <ul>
            <li>Verify your transaction details at the bank by using the transaction id and set password</li>
            <li>You will recieve the cash accordingly</li>
        </ul>
        <br />
    </form>
</body>
